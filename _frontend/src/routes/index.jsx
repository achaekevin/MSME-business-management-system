...
const router = createBrowserRouter([
  ...
  { path: 'dashboard', element: <PrivateRoute><Navigate to="/app/dashboard" replace /></PrivateRoute> },
  { path: 'products', element: <PrivateRoute><Navigate to="/app/products" replace /></PrivateRoute> },
  { path: 'products/new', element: <PrivateRoute><Navigate to="/app/products/new" replace /></PrivateRoute> },
  { path: 'products/:id', element: <PrivateRoute><Navigate to="/app/products" replace /></PrivateRoute> },
  { path: 'inventory', element: <PrivateRoute><Navigate to="/app/inventory" replace /></PrivateRoute> },
  { path: 'inventory/stock', element: <PrivateRoute><Navigate to="/app/inventory/stock" replace /></PrivateRoute> },
  { path: 'inventory/adjust', element: <PrivateRoute><Navigate to="/app/inventory/adjust" replace /></PrivateRoute> },
  { path: 'inventory/transfer', element: <PrivateRoute><Navigate to="/app/inventory/transfer" replace /></PrivateRoute> },
  { path: 'sales', element: <PrivateRoute><Navigate to="/app/sales" replace /></PrivateRoute> },
  { path: 'sales/pos', element: <PrivateRoute><Navigate to="/app/sales/pos" replace /></PrivateRoute> },
  { path: 'customers', element: <PrivateRoute><Navigate to="/app/customers" replace /></PrivateRoute> },
  ...
  { path: 'payroll', element: <PrivateRoute><Navigate to="/app/payroll" replace /></PrivateRoute> },
  { path: 'reports', element: <PrivateRoute><Navigate to="/app/reports" replace /></PrivateRoute> },
  { path: 'analytics', element: <PrivateRoute><Navigate to="/app/analytics" replace /></PrivateRoute> },
  { path: 'export', element: <PrivateRoute><Navigate to="/app/export" replace /></PrivateRoute> },
  { path: 'settings', element: <PrivateRoute><Navigate to="/app/settings" replace /></PrivateRoute> },
  { path: 'profile', element: <PrivateRoute><Navigate to="/app/profile" replace /></PrivateRoute> },
